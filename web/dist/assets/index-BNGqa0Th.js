 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(O,V){var B=O.length;O.push(V);e:for(;0<B;){var N=B-1>>>1,F=O[N];if(0<r(F,V))O[N]=V,O[B]=F,B=N;else break e}}function t(O){return O.length===0?null:O[0]}function i(O){if(O.length===0)return null;var V=O[0],B=O.pop();if(B!==V){O[0]=B;e:for(var N=0,F=O.length,ue=F>>>1;N<ue;){var ce=2*(N+1)-1,de=O[ce],ye=ce+1,Ne=O[ye];if(0>r(de,B))ye<F&&0>r(Ne,de)?(O[N]=Ne,O[ye]=B,N=ye):(O[N]=de,O[ce]=B,N=ce);else if(ye<F&&0>r(Ne,B))O[N]=Ne,O[ye]=B,N=ye;else break e}}return V}function r(O,V){var B=O.sortIndex-V.sortIndex;return B!==0?B:O.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,f=null,d=3,p=!1,_=!1,y=!1,m=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(O){for(var V=t(u);V!==null;){if(V.callback===null)i(u);else if(V.startTime<=O)i(u),V.sortIndex=V.expirationTime,e(l,V);else break;V=t(u)}}function x(O){if(y=!1,g(O),!_)if(t(l)!==null)_=!0,$(S);else{var V=t(u);V!==null&&K(x,V.startTime-O)}}function S(O,V){_=!1,y&&(y=!1,h(L),L=-1),p=!0;var B=d;try{for(g(V),f=t(l);f!==null&&(!(f.expirationTime>V)||O&&!H());){var N=f.callback;if(typeof N=="function"){f.callback=null,d=f.priorityLevel;var F=N(f.expirationTime<=V);V=n.unstable_now(),typeof F=="function"?f.callback=F:f===t(l)&&i(l),g(V)}else i(l);f=t(l)}if(f!==null)var ue=!0;else{var ce=t(u);ce!==null&&K(x,ce.startTime-V),ue=!1}return ue}finally{f=null,d=B,p=!1}}var R=!1,E=null,L=-1,T=5,w=-1;function H(){return!(n.unstable_now()-w<T)}function Y(){if(E!==null){var O=n.unstable_now();w=O;var V=!0;try{V=E(!0,O)}finally{V?Q():(R=!1,E=null)}}else R=!1}var Q;if(typeof v=="function")Q=function(){v(Y)};else if(typeof MessageChannel<"u"){var I=new MessageChannel,W=I.port2;I.port1.onmessage=Y,Q=function(){W.postMessage(null)}}else Q=function(){m(Y,0)};function $(O){E=O,R||(R=!0,Q())}function K(O,V){L=m(function(){O(n.unstable_now())},V)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(O){O.callback=null},n.unstable_continueExecution=function(){_||p||(_=!0,$(S))},n.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<O?Math.floor(1e3/O):5},n.unstable_getCurrentPriorityLevel=function(){return d},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(O){switch(d){case 1:case 2:case 3:var V=3;break;default:V=d}var B=d;d=V;try{return O()}finally{d=B}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(O,V){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var B=d;d=O;try{return V()}finally{d=B}},n.unstable_scheduleCallback=function(O,V,B){var N=n.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?N+B:N):B=N,O){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=B+F,O={id:c++,callback:V,priorityLevel:O,startTime:B,expirationTime:F,sortIndex:-1},B>N?(O.sortIndex=B,e(u,O),t(l)===null&&O===t(u)&&(y?(h(L),L=-1):y=!0,K(x,B-N))):(O.sortIndex=F,e(l,O),_||p||(_=!0,$(S))),O},n.unstable_shouldYield=H,n.unstable_wrapCallback=function(O){var V=d;return function(){var B=d;d=V;try{return O.apply(this,arguments)}finally{d=B}}}})(vg);_g.exports=vg;var U0=_g.exports;/**
 * @license React
